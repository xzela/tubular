...
def generate_room(len):
    word = ''
    for i in range(len):
        word += random.choice('0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ')
    return word
...
class MainPage(webapp.RequestHandler):
    ...
    def get(self):
        ...
        # room_link = 'http://localhost:8083/?r=' + room_key
        room_link = '/?r=' + room_key
        if debug:
